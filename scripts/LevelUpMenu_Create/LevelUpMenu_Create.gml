...
function LevelUpMenu_Create() {
	...
	*/
	...
	// (v2.1.4: the LEVEL UP! chat toast moved to update_menus, where the menu actually
	//  opens. This Create runs once at boot from obj_start_Create, so the toast showed
	//  on every launch.)
