...
function Audio_Create() {
	...
	*/
	...
	var _nm_boss = ["mus_Gremlins2_FinalBattle","mus_DarkLink_MortalKombatTheme","mus_Castlevania_Boss_Battle_Poison_Mind","mus_Contra_Boss_Battle","mus_Dragon_Warrior_Battle_Theme","mus_Dragon_Warrior_Dragon_Lord_Theme","mus_Mega_Man_2_Wily_Fortress_1","mus_TMNT2_Arcade_Game","mus_Wizards_Warriors_Boss_Battle"];
