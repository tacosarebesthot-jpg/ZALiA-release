...
function Audio_Create() {
	...
	*/
	...
	var _nm_title    = ["mus_WW_MusicIntro","mus_Gauntlet_MenuTheme","mus_Metroid_TitleFDS","mus_MM2_IntroTheme","mus_ActRaiser_Opening","mus_Faxanadu_Opening","mus_GuardianLegend_Title","mus_MM3_Title","mus_NG2_ApproachingEvil","mus_Silius_Title","mus_SuperMetroid_Theme"];
