...
function Audio_Create() {
	...
	*/
	...
	// NEW 2026-07-27: 4 more imported (HeroQuest title, Gremlins 2 x3). Pools taken
	// from the filename prefixes the ripper used -- TOWN_LEVEL, LEVEL, BOSS.
	...
	var _nm_ow_town = ["mus_HeroQuest_TitleTheme","mus_FF2_VillageTheme","mus_BionicCommando_Area1","mus_Shatterhand_AreasEF","mus_RushNAttack_StageTheme1","mus_OoT_Market","mus_OoT_Hyrule_Castle_Courtyard","mus_OoT_Lon_Lon_Ranch","mus_Blades_of_Steel_Menu_Theme","mus_Blaster_Master_Area_1","mus_Castlevania_Stage_01_Vampire_Killer","mus_Castlevania_Stage_04_Stalker","mus_Commando_Area_Theme","mus_Dr_Mario_Chill_Theme","mus_Dr_Mario_Title_Theme","mus_Dr_Mario_Fever","mus_Dragon_Warrior_Castle_Theme","mus_Dragon_Warrior_Village_Theme","mus_Drouble_Dribble_Menu","mus_Duck_Tales_Title_Theme","mus_Duck_Tales_Amazon_Stage","mus_Ghosts_n_Goblins_Stage_Theme_01","mus_Kid_Icarus_Title_Screen","mus_R_B_I_Baseball_Game_Theme","mus_Super_Mario_Bros_2_Overworld_Theme","mus_ActRaiser_Fillmore","mus_CT_CorridorsOfTime","mus_CT_MillennialFair","mus_Crystalis_Fields","mus_Crystalis_Town","mus_DC_EnchantedForest","mus_FF6_Terra","mus_Faxanadu_Overworld","mus_Faxanadu_Town","mus_MMX_OpeningStage","mus_SCV4_ForestOfMonsters","mus_SM_BrinstarGreen","mus_StarTropics_Overworld","mus_StarTropics_Town","mus_MM3_StaffRoll","mus_MM5_StaffRoll"];
	var _nm_level = ["mus_Gremlins2_Stage01","mus_Gremlins2_Stage05","mus_FF1_MatoyaCavern","mus_NinjaGaiden_Act4Pt2","mus_TownCountrySurf_LevelMusic","mus_DoubleDragon_Mission1","mus_TMNT2_Scene3","mus_Batman_Stage1","mus_CV_Stage07WickedChild","mus_CV_Stage13HeartOfFire","mus_CV_Stage06OutOfTime","mus_CV3_MadForest","mus_CV3_Clockwork","mus_FestersQuest_Track04","mus_FestersQuest_Track06","mus_Metroid_KraidsHideout","mus_SMB_CastleTheme","mus_MM1_CutmanStage","mus_MM2_WoodManStage","mus_OoT_Forest_Temple","mus_OoT_Spirit_Temple","mus_Commando_Underground_Bunker_1","mus_Contra_Enemy_Base","mus_Contra_Jungle_Theme","mus_Duck_Tales_African_Mines_Stage","mus_Duck_Tales_Moon_Stage","mus_Duck_Tales_Transylvania_Stage","mus_OoT_Gerudo_Valley_8bit","mus_Ghosts_n_Goblins_Stage_Theme_03","mus_Kid_Icarus_Angel_Land","mus_Kid_Icarus_Castle_Theme","mus_Kid_Icarus_Medusa_Fight","mus_Kid_Icarus_Sky_Palace","mus_Kid_Icarus_Sky_World","mus_Kid_Icarus_Underworld_Theme","mus_Mega_Man_2_Crash_Man_Stage","mus_Mega_Man_2_Flash_Man_Stage","mus_Mega_Man_2_Heat_Man_Stage","mus_Mega_Man_2_Metal_Man_Stage","mus_Mike_Tyson_s_Punch_Out_Fight_Theme","mus_Super_Mario_Bros_2_Cave_Theme","mus_Wizards_Warriors_Princess_Rescued","mus_Wizards_Warriors_Stage_1_Forest_of_Elrond_1","mus_Wizards_Warriors_Stage_2_Ice_Caves","mus_Wizards_Warriors_Stage_3_Fire_Caverns","mus_Wizards_Warriors_Stage_5_Forest_of_Elrond_2","mus_Wizards_Warriors_Stage_7_Inner_Castle","mus_Wizards_Warriors_Tree_Trunk_Level","mus_ActRaiser_Pyramid","mus_Batman_AxisChemical","mus_Bucky_GreenPlanet","mus_CT_SecretOfTheForest","mus_CT_TyranCastle","mus_CV3_Beginning","mus_CV3_DemonSeed","mus_Crystalis_Fortress","mus_Crystalis_Pyramids","mus_DC_LegendOfFirebrand","mus_DC_MetropolisOfRuin","mus_FF6_MinesOfNarshe","mus_FF6_PhantomForest","mus_Faxanadu_Labyrinth","mus_Faxanadu_Tower","mus_Gimmick_LionHeart","mus_Gimmick_StrangeMemories","mus_LittleSamson_Castle","mus_LittleSamson_Theme","mus_MM3_GeminiMan","mus_MM3_SparkMan","mus_MMX_SigmaStage1","mus_MMX_SparkMandrill","mus_MMX_StormEagle","mus_MetalStorm_Stage1","mus_NG2_RushingForward","mus_SCV4_BloodyTears","mus_SCV4_TheCave","mus_SCV4_ThemeOfSimon","mus_SM_NorfairLava","mus_SM_Tourian","mus_SM_WreckedShip","mus_Shatterhand_AreaC","mus_Silius_Stage1","mus_StarTropics_Dungeon","mus_SuperC_Area1","mus_MM1_ElecMan","mus_MM1_WilyCastle1","mus_MM2_AirMan","mus_MM2_BubbleMan","mus_MM2_QuickMan","mus_MM2_WilyCastle2","mus_MM3_HardMan","mus_MM3_MagnetMan","mus_MM3_NeedleMan","mus_MM3_ShadowMan","mus_MM3_SnakeMan","mus_MM3_TopMan","mus_MM3_WilyCastle1","mus_MM4_CossackFortress1","mus_MM4_DiveMan","mus_MM4_PharaohMan","mus_MM4_SkullMan","mus_MM5_GravityMan","mus_MM5_NapalmMan","mus_MM5_ProtoManFortress","mus_MM5_WaveMan","mus_MM6_FlameMan","mus_MM6_KnightMan","mus_MM6_TomahawkMan"];
	var _nm_boss = ["mus_Gremlins2_FinalBattle","mus_DarkLink_MortalKombatTheme","mus_Castlevania_Boss_Battle_Poison_Mind","mus_Contra_Boss_Battle","mus_Dragon_Warrior_Battle_Theme","mus_Dragon_Warrior_Dragon_Lord_Theme","mus_Mega_Man_2_Wily_Fortress_1","mus_TMNT2_Arcade_Game","mus_Wizards_Warriors_Boss_Battle","mus_ActRaiser_PowerfulEnemy","mus_Batman_Boss","mus_Bucky_Boss","mus_CT_BattleWithMagus","mus_CT_BossBattle1","mus_CV3_BossFight","mus_Crystalis_Boss","mus_DC_ChallengeOfDevils","mus_FF6_DecisiveBattle","mus_FF6_FierceBattle","mus_Faxanadu_Boss","mus_GuardianLegend_Boss1","mus_LittleSamson_Boss2","mus_MM3_Boss","mus_MMX_Boss2","mus_MetalStorm_Boss","mus_NG2_BossBattle","mus_SCV4_Boss1","mus_SCV4_DraculaBattle","mus_SM_BigBoss1","mus_Shatterhand_Boss","mus_Silius_Boss","mus_StarTropics_Boss","mus_SuperC_Boss","mus_MM3_WilyCastleBoss","mus_MM4_Boss","mus_MM5_Boss","mus_MM5_WilyBattle","mus_MM6_Boss"];
	...
	var _nm_title    = ["mus_WW_MusicIntro","mus_Gauntlet_MenuTheme","mus_Metroid_TitleFDS","mus_MM2_IntroTheme","mus_ActRaiser_Opening","mus_Faxanadu_Opening","mus_GuardianLegend_Title","mus_MM3_Title","mus_NG2_ApproachingEvil","mus_Silius_Title","mus_SuperMetroid_Theme","mus_MM4_Title"];
	...
	var _nm_tunnel        = ["mus_SMB_UndergroundTheme","mus_CT_UndergroundSewer","mus_KidIcarus_Underworld","mus_SM_CrateriaUnderground"];
	...
	// REMOVED 2026-09-12: mus_KickMaster_Sector4 -- the YouTube rip carried game SFX under the
	// music (Lane 09-11 0:47:27 "did we download someone's track that's just gameplay?";
	// fingerprinted against the VOD, 0.74 vs 0.13 for the next track; owner confirmed by ear).
	// === end NESmix wiring ==============================================================
