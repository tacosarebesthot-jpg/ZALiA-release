...
// ============================================================================
// The EIGHT player-facing zones, and the themes each one fans out to.
//
...
function jukebox_zone_themes(_zone) {
    ...
    switch (_zone)
    {
        ...
        case 2: // TOWNS and other safe interiors
            // _Basement01 MOVED OUT to zone 7 (2026-07-27). It is used by exactly
            // seven rooms -- the six town fast-travel basements and Darunia West --
            // so leaving it in here meant a track picked for the tunnels also played
            // in every town and house. Owner wanted SMB Underground in the tunnels
            // ONLY; that was written off as needing per-room music, but the tunnels
            // already have their own theme, so a narrow zone is all it took.
        ...
        case 7: // TUNNELS -- the town-to-town fast-travel basements
            return [STR_Basement+"01"];
    }
